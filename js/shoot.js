AFRAME.registerComponent("bullets", {
   ...
   removeBullet: function (e) {
      ...
      if (elementHit.id.includes("enemy")) {
        //Add code here
        var countMonsterE1 = document.querySelector("#countMonster");
        var monstersFired = parseInt(countMonsterE1.getAttribute("text").value);
        monstersFired -= 1;
        countMonsterE1.setAttribute("text", {
          value: monstersFired
        });
        if(monstersFired === 0) {
